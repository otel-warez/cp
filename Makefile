...
docker_linux_amd64: bin/cp_linux_amd64
	docker buildx build --push --platform="linux/amd64" -t ghcr.io/otel-warez/cp_linux_amd64:$(VERSION) --build-arg=bin/cp_linux_amd64 .

.PHONY := docker_linux_arm64
docker_linux_arm64: bin/cp_linux_arm64
	docker buildx build --push --platform="linux/arm64" -t ghcr.io/otel-warez/cp_linux_arm64:$(VERSION) --build-arg=bin/cp_linux_arm64 .

.PHONY := docker_linux_ppc64le
docker_linux_ppc64le: bin/cp_linux_ppc64le
	docker buildx build --push --platform="linux/ppc64le" -t ghcr.io/otel-warez/cp_linux_ppc64le:$(VERSION) --build-arg=bin/cp_linux_ppc64le .

.PHONY := docker_windows_arm64
docker_windows_arm64: bin/cp_windows_arm64.exe
	docker buildx build --push --platform="windows/arm64" -f Dockerfile.windows -t ghcr.io/otel-warez/cp_windows_arm64:$(VERSION) --build-arg=bin/cp_windows_arm64.exe .

.PHONY := docker_windows_amd64
docker_windows_amd64: bin/cp_windows_amd64.exe
	docker buildx build --push --platform="windows/amd64" -f Dockerfile.windows -t ghcr.io/otel-warez/cp_windows_amd64:$(VERSION) --build-arg=bin/cp_windows_amd64.exe .

.PHONY := docker_linux_amd64_fips
docker_linux_amd64_fips: bin/cp_linux_amd64_fips
	docker buildx build --push --platform="linux/amd64" -t ghcr.io/otel-warez/cp_linux_amd64_fips:$(VERSION) --build-arg=bin/cp_linux_amd64_fips .

.PHONY := docker_linux_arm64_fips
docker_linux_arm64_fips: bin/cp_linux_arm64_fips
	docker buildx build --push --platform="linux/arm64" -t ghcr.io/otel-warez/cp_linux_arm64_fips:$(VERSION) --build-arg=bin/cp_linux_arm64_fips .

.PHONY := docker_windows_amd64_fips
docker_windows_amd64_fips: bin/cp_windows_amd64_fips.exe
	docker buildx build --push --platform="windows/amd64" -f Dockerfile.windows -t ghcr.io/otel-warez/cp_windows_amd64_fips:$(VERSION) --build-arg=bin/cp_windows_amd64_fips.exe .

.PHONY := docker_windows_arm64_fips
docker_windows_arm64_fips: bin/cp_windows_arm64_fips.exe
	docker buildx build --push --platform="windows/arm64" -f Dockerfile.windows -t ghcr.io/otel-warez/cp_windows_arm64_fips:$(VERSION) --build-arg=bin/cp_windows_arm64_fips.exe .
